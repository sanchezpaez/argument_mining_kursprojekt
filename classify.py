...
def select_instances_per_label(corpus_file, output_file, instances_per_label=15):
    """Select only a few instances per label to make sample corpus and save it in file"""
    selected_instances = {}
    label_counts = {}
...
# Remove instances with label 'other'
corpus_df = corpus_df[corpus_df['Label'] != 'other']
...
#todo: test_size should be 0.2 for the whole dataset
X_train_dev, X_test, y_train_dev, y_test = train_test_split(corpus_df['Text'], encoded_labels, test_size=0.5,
